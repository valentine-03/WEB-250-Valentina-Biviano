...
// 1. READ: Changed '/api/records' to 'api/records'
...
recordForm.addEventListener('submit', async (e) => {
    ...
    if (id) {
        // 2. UPDATE: Changed `/api/records/${id}` to `api/records/${id}`
        ...
        // 3. CREATE: Changed '/api/records' to 'api/records'
...
// 4. DELETE: Changed `/api/records/${id}` to `api/records/${id}`
